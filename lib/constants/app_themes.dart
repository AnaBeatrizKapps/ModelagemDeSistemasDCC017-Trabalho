...
class AppThemes {
  ...
  static const Color lightBackgroundColor = Color(0xFFEFEFF4);
  static const Color lightPrimaryColor = Color(0xFFFFA234);
  static const Color _lightBackgroundColor = Color(0xFFEFEFF4);
